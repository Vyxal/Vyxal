...
commands = {
    ...
    'e': 'lhs, rhs = stack.pop(2); stack.push(exponent(rhs, lhs))',
    ...
    "√": "stack.push(exponent(stack.pop(), 0.5))",
    ...
    "Ŵ": "length, iterable = stack.pop(2); iterable = as_iter(iterable)\nif type(iterable) is str: iterable = Stack(list(iterable))\nstack.push(Stack(list(itertools.combinations(iterable.contents, length))))",
