...
def encode():
    parser = argparse.ArgumentParser(description='Encodes Vyxal code as a bit string.')
    parser.add_argument('code', type=str, help='Vyxal code to be encoded')
    parser.add_argument('-v', dest='verbose', action='store_const', const=sum, default=max, help='verbose')
...
def decode():
    parser = argparse.ArgumentParser(description='Decodes Vyxal code from a bit string.')
