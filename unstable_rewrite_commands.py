...
command_dict = {
    ...
    "M": "fn, vector = pop(stack, 2); print(fn, vector); stack.append(VY_map(fn, vector))",
    "N": "pass",
    ...
    "ū": "index, vector = pop(stack, 2); stack.append(iterable(vector)[1:index])",
    ...
    "ů": "string, new, original = pop(stack, 3); stack.append(transilterate(iterable(original), iterable(new), iterable(string)))",
