...
| <code>⌽</code> | <code>1-slice</code></br><code>tail-take</code></br><code>1-take</code> | 2 |   | **1 Slice** (`itr,num`): First #2 elements of #1[1:]</br>**1 Slice** (`num,itr`): First #1 elements of #2[1:] |
...
| <code>ʁ</code> | <code>0->n++</code></br><code>uppercase</code></br><code>range-0->n++</code></br><code>n+range-0</code></br><code>inclusive-range</code> | 1 | vec  | **Range 0 Inclusive** (`num`): Range from 0 to #1, inclusive</br>**Uppercase** (`str`): Uppercase #1 |
