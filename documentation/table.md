...
| <code>c</code> | <code>contains</code></br><code>contains?</code></br><code>is-in</code> | 2 |   | **Contains** (`scl,scl`): Is #2 in #1</br>**Contains** (`lst,scl`): Is #2 in #1</br>**Contains** (`scl,lst`): Is #1 in #2</br>**Contains** (`lst,lst`): Is the list with shallower depth in the list with deeper depth |
...
| <code>↻</code> | <code>rot-right</code> | 1 |   | **Rotate Right** (`lst\|str`): Rotate #1 right</br>**Rotate Right** (`lst\|str,num`): Rotate #1 right #2 times. Left if #2 is negative |
...
| <code>ꜝ</code> | <code>keep-truthy</code></br><code>split-whitespace</code> | 1 |   | **Keep Truthy** (`lst\|num`): Keep only the truthy elements of #1</br>**Split whitespace** (`str`): Equivalent to `e⌈` |
