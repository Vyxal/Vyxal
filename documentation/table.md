...
| <code>Q</code> | <code>remove-at</code></br><code>regex-groups</code> | 2 |   | **Remove At** (`nsl,num`): Remove the element at index #2 from #1</br>**Regex Groups** (`str,str`): Return the groups of the first match of #2 in #1 |
