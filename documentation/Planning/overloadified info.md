...
- [x] ¹ () = second input
- [x] ² (num) = Square
- [x]   (str) = a split into pairs
- [x] ³ (num) = cube
- [x]   (str) = a split into chunks of length 3
- [x] ⅟ (num) = 1 / x
- [x]   (str) = a with all whitespace removed
- [x] ※ (any) = group by consecutive values
...
- [x] ± (num) = sign of a
- [ ]   (str) = tbd
- [x] † (any) = lengths of consecutive groups
- [x] ⎙ (any) = print without popping
- [x] ✒ (any) = print (not println)
- [x] ≓ (num) = a + reversed(a) (as number)
- [x]   (str) = a + reversed(a)
...
- [x] ⌹ (lst) = List partitions of a
- [x]    (num) = Integer partitions of a (all possible ways to sum to a)
- [x] ⏚ (lst) = powerset
- [x] ↯ (lst, fun) = sort by function
- [x]   (num, num) = range(a, b+1) ([a, b])
- [x]   (str, str) = split on regex b and keep the delimiters
- [x] ⊠ (lst, num) = Cartesian power
- [x] ⚅ (num) = randint(0, a)
- [x]    (str|lst) = random element from a
- [x] æ (any) = a, a[::-1]
- [x] ␣ () = " " (space)
- [x] ¶ () = "\n" (newline)
- [x] ★ () = "*" (Asterisk)
...
- [ ] #◌ () = list of all inputs
- [x] δ (lst) = forward differences (⊞-)
- [x] ☷ (lst, lst) = Partition y after truthy indices of x.
- [x] ✇ (lst|str) = Edges. [x[0], x[-1]]
- [x]    (num) = [real, complex]
- [x] ⎃ (any) = Flatten x and join on nothing
