...
object ElementInformation:
  ...
  private def elements1: Map[String, Element] =
    Map(
      AddElement(
        symbol = "Ƶ",
        keywords = Seq(
        ...
        Overload(
          ...
          args = Seq("any", "fun"),
          description =
            "Apply #2 to the last element of #1. #1[:-1] + #2(#1[-1])",
        ),
      ),
      AddElement(
        symbol = "⊞",
      ...
      AddElement(
        ...
        Overload(
          name =
            "Concatenate sublists then join on Newlines (Element Form of Ꮬ)",
          args = Seq("lst"),
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("lst", "fun"),
          description =
            "Reduce overlapping pairs in {#1|#2} by function {#2|#1}",
        ),
        Overload(
        ...
        Overload(
          ...
          args = Seq("dur", "dur"),
          description =
            "Absolute difference between duration #1 and duration #2",
        ),
      ),
      AddElement(
        symbol = "A",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("date"),
          description =
            "Extract [year, month, day, hour, minute, second] from date #1",
        ),
      ),
      AddElement(
        symbol = "F",
      ...
      AddElement(
        symbol = "e",
        keywords =
          Seq("even?", "is-even", "split-newlines", "/newline", "leap-year?"),
        arity = 1,
        Options(vectorises = true),
        Overload(
          name = "Is Even",
      ...
      AddElement(
        symbol = "σ",
        keywords =
          Seq("cumulative-sums", "cumsums", "cumsum", "cum-sum", "-_-"),
        arity = 1,
        Options(),
        Overload(
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("str", "str"),
          description =
            "Append spaces to string #1 until it is the length of #2",
        ),
      ),
      AddElement(
        symbol = "Ɠ",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq(),
          description =
            "Push the entire register to the stack, wrapped in a list",
        ),
      ),
      AddElement(
        symbol = "Þ^",
      ...
      AddElement(
        symbol = "⊢",
        keywords =
          Seq("ten-to-base", "all-regex-matches", "to-base", "to-timezone"),
        arity = 2,
        Options(),
        Overload(
          ...
          args = Seq("date", "str"),
          description =
            "Convert date #1 to timezone #2 (e.g., \"UTC\", \"America/New_York\")",
        ),
        Overload(
          name = "10 to Base",
          args = Seq("num", "num"),
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("str"),
          description =
            "Case of #1 (1 if uppercase, 0 if lowercase, -1 if mixed)",
        ),
      ),
      AddElement(
        symbol = "†",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("lst"),
          description =
            "Sum of each item in #1. Functionally equivalent to `¨∑`",
        ),
        Overload(
          name = "Push N spaces",
          args = Seq("num"),
  ...
  private def elements2: Map[String, Element] =
    Map(
      AddElement(
        symbol = "“",
        keywords = Seq(
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq(),
          description =
            "Push \"\\|/-_\" to the stack - useful for drawing lines",
        ),
      ),
      AddElement(
        symbol = "kF",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq(),
          description =
            "Push `0123456789abcdefghijklmnopqrstuvwxyz` to the stack",
        ),
      ),
      AddElement(
        symbol = "kT",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("num"),
          description =
            "Convert #1 to base 252, using the codepage as the digits",
        ),
      ),
      AddElement(
        symbol = "#Q",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq(),
          description =
            "Push the first day of the current month at midnight as a VDate",
        ),
      ),
      AddElement(
        symbol = "#y",
        ...
        Overload(
          ...
          args = Seq(),
          description =
            "Push the first day of the current year at midnight as a VDate",
        ),
      ),
      AddElement(
        symbol = "#z",
        ...
        Overload(
          ...
          args = Seq(),
          description =
            "Push a sorted list of all available timezone ID strings (e.g., \"UTC\", \"America/New_York\")",
        ),
      ),
      AddElement(
        symbol = "#t",
        keywords =
          Seq("make-date", "date-from-components", "to-date", "construct-date"),
        arity = 1,
        Options(),
        Overload(
          name = "Parse Date",
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("str"),
          description =
            "Parse string #1 as an ISO-8601 duration (e.g., \"PT2H30M\" for 2 hours 30 minutes)",
        ),
        Overload(
          name = "Duration from Decimal Days (Number)",
          args = Seq("num"),
          description =
            "Create a duration from #1 decimal days (e.g., 1.5 = 36 hours)",
        ),
      ),
      AddElement(
        symbol = "∆<",
      ...
      AddElement(
        symbol = "ø»",
        keywords =
          Seq("pad-right-with", "custom-right-pad", "custom-pad-right"),
        arity = 3,
        Options(vectorises = true),
        Overload(
      ...
      AddElement(
        ...
        Overload(
          ...
          args = Seq("str", "str"),
          description =
            "Join #1 and #2, such that each line of #2 is at the end of a line of #1. Extra lines in #2 are discarded. Equivalent to ⎂eẄJ”",
        ),
      ),
      AddElement(
        symbol = "Þ⁰",
