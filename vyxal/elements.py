...
def vertical_palindromise_center_join(lhs, ctx):
    ...
    """
    return join_newlines(center(flip_brackets_vertical_palindromise(lhs, ctx=ctx), ctx=ctx), ctx=ctx)
...
def vertical_mirror_center_join(lhs, ctx):
    ...
    """
    return join_newlines(center(flip_brackets_vertical_mirror(lhs, ctx=ctx), ctx=ctx), ctx=ctx)
